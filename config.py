...
LOG_GROUP    = int(os.getenv("LOG_GROUP", "-1003028606590"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "-1003872571761"))
...
# ─── UI / LINKS ─────────────────────────────────────────────────────────────────
JOIN_LINK     = os.getenv("JOIN_LINK", "https://t.me/fordistrict")
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/fordistrict")
