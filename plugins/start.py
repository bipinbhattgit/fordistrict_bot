    ...
    if FORCE_SUB:
        try:
          ...
          if str(user.status) == "ChatMemberStatus.BANNED":
            ...
            await message.reply_photo(photo="https://avatars.githubusercontent.com/u/210998310?s=400&u=37941d828820328935a8480e6b3e7f3c9b448d95&v=4",caption=caption, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{link}")]]))
            return 1
...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="fordistrict")],
        ]
    )
...
async def plan(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/fordistrict")],
        ]
    )
